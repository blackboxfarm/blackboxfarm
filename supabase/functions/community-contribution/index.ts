...
import { Connection, PublicKey, Transaction, SystemProgram, sendAndConfirmTransaction, Keypair } from "npm:@solana/web3.js@1.95.3";
...
serve(withRunLog('community-contribution', async (req) => {
