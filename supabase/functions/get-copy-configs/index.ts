...
Deno.serve(withRunLog('get-copy-configs', async (req) => {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .select(`*, monitored_wallets!inner(wallet_address, label)`) // include wallet info like in UI
    ...
    console.error('get-copy-configs unexpected error:', e)
