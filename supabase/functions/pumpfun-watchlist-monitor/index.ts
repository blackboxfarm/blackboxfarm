            ...
            try {
              await supabase.functions.invoke('rug-event-processor', {
                body: {
                  ...
                  evidence: { dev_holding_pct: devHoldingPct, price_at_rug: token.price_usd, price_ath: token.price_ath_usd, market_cap_at_rug: token.market_cap_usd, holder_count: token.holder_count, volume_sol: token.volume_sol },
