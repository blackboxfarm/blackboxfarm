...
-- Rebuild view with launchpad inference from pumpfun_watchlist
...
SELECT
  ...
  -- LAUNCHPAD (infer pump.fun if token exists in pumpfun_watchlist)
  ...
  -- X COMMUNITIES (admin handles = confirmed admin, mod handles = moderator)
