-- Fix the track_campaign_state_change function to handle operations properly
...
BEGIN
    -- Only proceed if this is an UPDATE operation (not DELETE or INSERT)
