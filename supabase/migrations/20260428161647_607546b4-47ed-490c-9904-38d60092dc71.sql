-- Drop the old 3-hour schedule and recreate at every 15 minutes
SELECT cron.unschedule('insiders-pipeline-orchestrator-3h');

SELECT cron.schedule(
  'insiders-pipeline-orchestrator-15m',
  '*/15 * * * *',
  $$
