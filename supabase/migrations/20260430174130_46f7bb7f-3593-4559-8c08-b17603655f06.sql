...
COMMENT ON VIEW public.v_live_death_watch IS
  'Live Death Watch source: token_price_history ATH/latest collapse with cleaned metadata fallbacks and derived death cause/time when no explicit autopsy event exists.';