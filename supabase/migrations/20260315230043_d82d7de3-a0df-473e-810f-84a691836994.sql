...
-- Add ath_24h_usd to token_lifecycle
ALTER TABLE public.token_lifecycle ADD COLUMN IF NOT EXISTS ath_24h_usd numeric DEFAULT NULL;

COMMENT ON COLUMN public.token_lifecycle.ath_24h_usd IS 'All-time high price in USD during first 24h window, fetched from GeckoTerminal OHLCV';

-- Rebuild master_token_directory to include ath_24h_usd
