...
-- Create policy for super admin access only (service role or admin users)
...
USING (
    ...
    EXISTS (
        ...
        AND user_id IN (
            -- Add specific admin user IDs here or create admin role system
...
-- Insert some default wallet configurations (optional)
INSERT INTO public.super_admin_wallets (label, pubkey, secret_key_encrypted, wallet_type, is_active)
VALUES 
    ('Platform Treasury 2024', 'PLACEHOLDER_PUBKEY_1', 'PLACEHOLDER_SECRET_1', 'treasury', false),
    ('Campaign Funding Wallet', 'PLACEHOLDER_PUBKEY_2', 'PLACEHOLDER_SECRET_2', 'campaign_funding', false),
    ('Refund Processing Wallet', 'PLACEHOLDER_PUBKEY_3', 'PLACEHOLDER_SECRET_3', 'refund_processing', false),
    ('Emergency Operations Wallet', 'PLACEHOLDER_PUBKEY_4', 'PLACEHOLDER_SECRET_4', 'emergency', false)
