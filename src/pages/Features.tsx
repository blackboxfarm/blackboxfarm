...
const PRODUCT_PILLARS = [
  ...
  },
  {
    ...
    features: [
      "/quick /holders /ca — Holder analysis (Auth+)",
      "/risk /concentration — Risk & distribution (Auth+)",
      "/dev /ai — Developer intel & AI snapshot (Auth+)",
      "/momentum /insiders /compare — Advanced (X Sub+)",
      "/oracle /wallet — Deep reputation mesh (Pro)",
      "Group chat auto-scan with abbreviated intel",
    ],
    tier: "Free → Pro",
  },
  {
